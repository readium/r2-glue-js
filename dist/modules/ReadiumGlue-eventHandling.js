...
this.ReadiumGlue.eventHandling = (function (dispatcher_ts,messageHandler_ts) {
  ...
  ***************************************************************************** */
  ...
  var cssesc$1 = /*#__PURE__*/Object.freeze({
    default: cssesc_1,
    __moduleExports: cssesc_1
  });

  var cssesc$2 = ( cssesc$1 && cssesc_1 ) || cssesc$1;
  ...
  function id(input) {
      if (input.id !== '') {
          return {
              name: '#' + cssesc$2(input.id, { isIdentifier: true }),
              penalty: 0,
          };
      }
      return null;
  ...
  function classNames(input) {
      ...
      return names.map(function (name) { return ({
          name: '.' + cssesc$2(name, { isIdentifier: true }),
          penalty: 1
      }); });
  }
